    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.wrap}>
          <div className={styles.collumn_left}>
            <iframe
          ...
          <div className={styles.collumn_right}>
            <h2>
              Первичная профсоюзная орагнизация Колледжа Современных Технологий
            </h2>
            <div className={styles.rows_block}>
              <div className={styles.row}>
                <User size={30} /> Председатель -{' '}
                <span>Глушенкова Светлана Борисовна</span>
              </div>
              <div className={styles.row}>
            ...
            <p className={styles.title_section}>Профсоюз-КСТ © 2025</p>
          </div>
        </div>
      </div>
    </footer>
